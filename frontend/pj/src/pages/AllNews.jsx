...
const AllNews = () => {
  ...
  const [reactions, setReactions] = useState({}); // ✅ separate reactions state
  ...
  // ✅ Fetch all news (without reactions)
  ...
  // ✅ Fetch like/dislike for one news
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-5 md:p-10">
      <div className="max-w-6xl mx-auto">
        ...
        {newsList.map((news) => {
          const reaction = reactions[news.id] || {
            likeCount: 0,
            dislikeCount: 0,
            userAction: "NONE",
          };
